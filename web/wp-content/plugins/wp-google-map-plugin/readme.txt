...
= 4.4.6 =
* Fix : fixed frontend notice messages.

= 4.4.5 =
* Fix : Security issue related to manage location page in backend fixed.
* Fix : Styles and scripts of plugin are loaded only when map shortcode exists on page.
* New : Used addEventListener method instead of deprecation addDomListener method to apply best practice.
