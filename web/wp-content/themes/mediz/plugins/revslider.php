<?php
	...
	add_filter('revslider_getUsedFonts', 'mediz_revslider_getUsedFonts');
	if( !function_exists('mediz_revslider_getUsedFonts') ){
		function mediz_revslider_getUsedFonts( $used_font ){
