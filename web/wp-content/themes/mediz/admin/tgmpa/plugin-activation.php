	...
	*/		
	...
	if( !function_exists('mediz_register_required_plugins') ){
		function mediz_register_required_plugins(){
			...
			$plugins = array(
				array(
					'name'               => esc_html__('Goodlayers Core', 'mediz'),
				...
				array(
					'name'               => esc_html__('Goodlayers Core Portfolio', 'mediz'),
				...
				array(
					'name'               => esc_html__('Goodlayers Core Personnel', 'mediz'),
				...
				array(
					'name'               => esc_html__('Goodlayers Core Twitter', 'mediz'),
				...
				array(
					'name'               => esc_html__('Revolution Slider', 'mediz'),
					'slug'               => 'revslider', 
				...
				array(
					'name'      => esc_html__('Timetable and Event Schedule by MotoPress', 'mediz'),
					'slug'      => 'mp-timetable',
					'required'  => false,
				),
			);
